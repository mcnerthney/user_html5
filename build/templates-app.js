angular.module('templates-app', ['about/about.tpl.html', 'home/home.tpl.html', 'login/login.tpl.html', 'signup/signup.tpl.html', 'ticketType/ticketType.tpl.html']);
...
angular.module("login/login.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("login/login.tpl.html",
    ...
    "          <input required ng-model=\"input.email\" type=\"email\" class=\"form-control\" id=\"email\" placeholder=\"Enter email\">\n" +
    "        </div>\n" +
    "        <div class=\"form-group\">\n" +
    "          <label for=\"oassword\">Password</label>\n" +
    "          <input required ng-model=\"input.password\" type=\"password\" class=\"form-control\" id=\"password\" placeholder=\"Password\">\n" +
    "        </div>\n" +
    "        <button ng-click=\"submit()\" ng-disabled=\"busy || loginForm.$invalid\" type=\"submit\" class=\"btn btn-default\">Submit</button>\n" +
    "      </form>\n" +
    "</div>\n" +
    "\n" +
    "");
...
angular.module("signup/signup.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("signup/signup.tpl.html",
    ...
    "          <input required ng-model=\"input.password\" type=\"password\" class=\"form-control\" id=\"password\" placeholder=\"Password\">\n" +
    "        </div>\n" +
    "        <button ng-click=\"submit()\" ng-disabled=\"busy || signupForm.$invalid\" type=\"submit\" class=\"btn btn-default\">Submit</button>\n" +
    "      </form>\n" +
    "      <div>\n" +
    "</div>\n" +
    "\n" +
...
angular.module("ticketType/ticketType.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("ticketType/ticketType.tpl.html",
    "<div class=\"jumbotron\">\n" +
    "  <h1>Zoute</h1>\n" +
    "  <h3> Hello VTA! </h3>\n" +
    "\n" +
